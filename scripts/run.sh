...
CUDA_VISIBLE_DEVICES=2 python3 train.py env=${ENV_NAME} her_iters=4 her_strat=future experiment=fetch_pick_her0_futureA save_video=true eval_frequency=10000 
