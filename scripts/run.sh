...
CUDA_VISIBLE_DEVICES=1 taskset 0,1,2,3,4,5,6,7 python train.py env=${ENV_NAME} her_iters=4 her_strat=future experiment=fetch_pick_her4_futureA_attention save_video=true eval_frequency=10000
