...
CUDA_VISIBLE_DEVICES=0 taskset 0,1,2,3,4,5,6,7 python train.py env=FetchBlockHRL_1Blocks_SparseReward_DictstateObs_84Rendersize_TrueStackonly_PickupCase-v1 her_iters=0 her_strat=future experiment=fetch_pickup_3block_noreset_image save_video=true eval_frequency=10000