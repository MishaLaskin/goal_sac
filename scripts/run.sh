...
CUDA_VISIBLE_DEVICES=1 taskset 16,17,18,19,20,21,22,23 python train.py env=FetchBlockHRL_3Blocks_SparseReward_DictstateObs_84Rendersize_TrueStackonly_PutdownCase-v1 her_iters=4 her_strat=future experiment=fetch_putdown_3block_randomreset_lrsched save_video=true eval_frequency=10000
