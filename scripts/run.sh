...
CUDA_VISIBLE_DEVICES=6 taskset 0,1,2,3,4,5,6,7 python train.py env=FetchBlockHRL_3Blocks_SparseReward_DictimageObs_84Rendersize_TrueStackonly_PutdownCase-v1 her_iters=0 her_strat=future experiment=fetch_image_pickup_2block save_video=true eval_frequency=1000